...
assert(html.includes('<link rel="apple-touch-icon" href="/sixgun-retriever-ios-icon.png?v=2.13.8">'), "iOS must use the cache-busted dog-logo touch icon");
assert(html.includes('<link rel="apple-touch-icon-precomposed" href="/sixgun-retriever-ios-icon.png?v=2.13.8">'), "older iOS versions must use the cache-busted dog-logo icon");
